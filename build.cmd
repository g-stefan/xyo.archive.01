...
if not exist ".\build\build.%1.cmd" goto SelectDefaultPlatform
call ".\build\build.%1.cmd" %2
goto :eof
...
if not exist ".\build\build.%DEFAULT_PLATFORM%.cmd" goto Info
call ".\build\build.%DEFAULT_PLATFORM%.cmd" %1
goto :eof
:Info
