...
call :cmdX temp\xyo.cc --mode=debug @source/util/xyo.static.compile.info
call :cmdX temp\xyo.cc --mode=debug @source/util/xyo.dynamic.compile.info
call :cmdX temp\xyo.cc --mode=debug --exe xyo.test.01 @source/util/xyo.test.compile.info
call :cmdX temp\xyo.cc --mode=debug --exe xyo.test.02 @source/util/xyo.test.compile.info
call :cmdX temp\xyo.cc --mode=debug --exe xyo.test.03 @source/util/xyo.test.compile.info
call :cmdX temp\xyo.cc --mode=debug --exe xyo.test.04 @source/util/xyo.test.compile.info

call :cmdX temp\xyo.cc --mode=debug @source/util/xyo-cc.compile.info
